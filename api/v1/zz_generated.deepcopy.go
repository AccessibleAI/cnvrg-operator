...
func (in *SSO) DeepCopyInto(out *SSO) {
	*out = *in
	...
	if in.ExtraJWTIssuers != nil {
		in, out := &in.ExtraJWTIssuers, &out.ExtraJWTIssuers
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	in.SaaSSSO.DeepCopyInto(&out.SaaSSSO)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SaaSSSO) DeepCopyInto(out *SaaSSSO) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SaaSSSO.
func (in *SaaSSSO) DeepCopy() *SaaSSSO {
	if in == nil {
		return nil
	}
	out := new(SaaSSSO)
