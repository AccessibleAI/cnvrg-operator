...
import (
	...
	"github.com/AccessibleAI/cnvrg-operator/pkg/thirdparty/gpu"
...
func (r *CnvrgThirdPartyReconciler) applyManifests(cnvrgTp *mlopsv1.CnvrgThirdParty) error {
	...
	if cnvrgTp.Spec.Gpu.NvidiaDp.Enabled {
