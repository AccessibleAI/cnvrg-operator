...
//			Expect(tc.client.Create(ctx, testApp)).Should(Succeed())
//			Eventually(func() bool {
//				err := tc.client.Get(ctx, types.NamespacedName{Name: testApp.Spec.Dbs.Pg.SvcName, Namespace: ns}, &deployment)
//				if err != nil {
//					return false
//				}
//				return true
...
//			Expect(tc.client.Delete(ctx, testApp)).Should(Succeed())
//		})
...
//			Eventually(func() bool {
//				err := tc.client.Get(ctx, types.NamespacedName{Name: testApp.Spec.Dbs.Pg.CredsRef, Namespace: ns}, &pgCreds)
//				if err != nil {
//					return false
//				}
//				return true
...
//			Eventually(func() bool {
//				err := tc.client.Get(ctx, types.NamespacedName{Name: "cnvrgapp", Namespace: ns}, &appRes)
//				if err != nil {
//					return false
//				}
//				return true
...
//			Expect(tc.client.Update(ctx, &appRes)).Should(Succeed())
//			sts := v1.StatefulSet{}
//			Eventually(func() bool {
//				err := tc.client.Get(ctx, types.NamespacedName{Name: testApp.Spec.Dbs.Es.SvcName, Namespace: ns}, &sts)
//				if err != nil {
//					return false
//				}
//				return true
...
//			Eventually(func() bool {
//				err := tc.client.Get(ctx, types.NamespacedName{Name: testApp.Spec.Dbs.Pg.CredsRef, Namespace: ns}, &pgCredsAfterReconcile)
//				if err != nil {
//					return false
//				}
//				return true
...
//	err := tc.client.Create(context.Background(), testNs)
//	if err != nil {
//		panic(err)
//	}
//	return ns
