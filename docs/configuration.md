...
9. [Tenancy options](#tenancy-options)
10. [Registry options](#registry-options)
11. [Labels and Annotations](#labels-and-annotations)
12. [Automatic Config Reload](#automatic-config-reloader)
