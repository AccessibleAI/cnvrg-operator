...
|`controlPlane.cnvrgRouter.image`|nginx
|`controlPlane.cnvrgRouter.nodePort`|30081
|`controlPlane.cnvrgRouter.port`|80
|`controlPlane.cnvrgRouter.svcName`|routing-service
|`controlPlane.hyper.cpuLimit`|2
...
|`controlPlane.sidekiq.cpu`|1750m
