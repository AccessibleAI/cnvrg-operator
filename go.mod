...
require (
	...
	github.com/AccessibleAI/cnvrg-shim v0.0.31-CLD-1385-remove-as-much-crds-as-possible-21
	...
	istio.io/istio v0.0.0-20230115095728-c2e069cb6e07
	k8s.io/api v0.29.0
...
require (
	...
	istio.io/api v1.20.1 // indirect
	istio.io/client-go v1.20.1 // indirect
